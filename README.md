...
- **Biblioteca Escolar & Cantinho da Leitura (Acervo Integrado & Descentralizado)**:
  ...
  - **Gestão de Acervo Multi-Escola**: controle patrimonial por unidade escolar (`copiesBySchool`), cálculo de exemplares livres vs. emprestados e filtros integrados por escola.
  - **Circulação & Empréstimos**: empréstimo direto para alunos por turma, controle automático de prazos de devolução, detecção de atrasos em tempo real e renovação rápida com 1 clique (+7 dias).
  - **Cantinho da Leitura em Sala de Aula**: extensão pedagógica na sala onde o professor aloca títulos do acervo central da escola, gerencia a estante da sala, registra empréstimos rápidos para alunos e devolve ao acervo central ao final do ciclo.
